...
function validateArguments(src, filename) {
    errors_1.invariant(shared_1.isString(src), errors_1.TransformerErrors.INVALID_SOURCE, [src]);
    errors_1.invariant(shared_1.isString(filename), errors_1.TransformerErrors.INVALID_ID, [filename]);
}
