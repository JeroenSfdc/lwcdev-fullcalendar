var LWC = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var _d = String.prototype, StringCharCodeAt$1 = _d.charCodeAt, StringReplace$1 = _d.replace, StringToLowerCase$1 = _d.toLowerCase;
    ...
    function htmlPropertyToAttribute$1(propName) {
        ...
        for (var i_1 = 0, len = propName.length; i_1 < len; i_1++) {
            var code = StringCharCodeAt$1.call(propName, i_1);
            if (code >= 65 && // "A"
                code <= 90 // "Z"
            ) {
    ...
    var _f = Array.prototype, ArrayIndexOf$1 = _f.indexOf, ArrayJoin = _f.join, ArrayMap$1 = _f.map, ArrayPush$2 = _f.push, ArraySlice = _f.slice, ArrayUnshift = _f.unshift, forEach = _f.forEach;
    ...
    var globalHTMLProperties = assign$1(create$2(null), {
        accessKey: {
            attribute: 'accesskey'
        },
        accessKeyLabel: {
    ...
    */
    ...
    function getLightningElementPrototypeRestrictionsDescriptors(proto) {
        ...
        forEach.call(getOwnPropertyNames$2(globalHTMLProperties), function (propName) {
    ...
    var LightningElement = function () {
        ...
        var elm = vm.elm, renderer = vm.renderer, _b = vm.def, ctor = _b.ctor, bridge = _b.bridge;
        if (process.env.NODE_ENV !== 'production') {
        ...
        return {
            ...
            set: function (newValue) {
                ...
                if (process.env.NODE_ENV !== 'production') {
                    ...
                    assert.invariant(!isInvokingRender, vmBeingRendered_3 + ".render() method has side effects on the state of " + vm + "." + toString$1(key));
                    assert.invariant(!isUpdatingTemplate, "Updating the template of " + vmBeingRendered_3 + " has side effects on the state of " + vm + "." + toString$1(key));
                }
        ...
        return {
            ...
            set: function (newValue) {
                ...
                if (process.env.NODE_ENV !== 'production') {
                    ...
                    assert.invariant(!isInvokingRender, vmBeingRendered_4 + ".render() method has side effects on the state of " + vm + "." + toString$1(key));
                    assert.invariant(!isUpdatingTemplate, "Updating the template of " + vmBeingRendered_4 + " has side effects on the state of " + vm + "." + toString$1(key));
                }
        ...
        return {
            ...
            set: function (newValue) {
                ...
                if (process.env.NODE_ENV !== 'production') {
                    ...
                    assert.invariant(!isInvokingRender, vmBeingRendered_5 + ".render() method has side effects on the state of " + vm + "." + toString$1(key));
                    assert.invariant(!isUpdatingTemplate, "Updating the template of " + vmBeingRendered_5 + " has side effects on the state of " + vm + "." + toString$1(key));
                }
                if (set) {
    ...
    function fallbackElmHook(elm, vnode) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            var context = vnode.data.context;
            var isPortal = !isUndefined$3(context) && !isUndefined$3(context.lwc) && context.lwc.dom === LWCDOMMode.manual;
    ...
    if (process.env.NODE_ENV === 'development') {
        ...
        window.__lwcResetGlobalStylesheets = function () {
            for (var _i = 0, _b = Object.keys(globalStylesheets); _i < _b.length; _i++) {
                var key = _b[_i];
